...
class ProductController extends Controller
{
    ...
    public function storeProduct(Request $request)
    {
        ...
        $product->available_quantity = $request->available_quantity ?? 0;
    ...
    public function productUpdate(Request $request)
    {
        ...
        $product->unit_type = $request->unit_type;
        $product->description = $request->description;
        $product->available_quantity = $request->available_quantity ?? $product->available_quantity;
...
public function productBarcodeGenerate(Request $request)
{
    ...
    $qty = (int) $request->barcode_qty;

    $generator = new BarcodeGeneratorHTML();
    $barcode = $generator->getBarcode($product->code, $generator::TYPE_CODE_128);

    return view('adminPanel.product.barcode_generate', compact(
        'product',
        'qty',
        'barcode'
    ));
