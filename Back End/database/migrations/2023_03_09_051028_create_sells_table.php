...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('sells', function (Blueprint $table) {
            ...
            $table->decimal('sub_total', 11, 3)
                ->default(0)
                ->after('bank_id')
                ->comment('Product total excluding shipping, tax & discount');
            ...
            $table->timestamp('cancel_accepted_at')->nullable();
            $table->timestamp('cancel_completed_at')->nullable();
