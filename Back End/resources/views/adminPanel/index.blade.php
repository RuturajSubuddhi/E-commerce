                        ...
                        <div class="table-responsive">
                            <table class="table align-middle mb-0">
                                ...
                                @foreach($lastOrder as $orderList)
                                    <tr>
                                        <td>{{strlen($orderList->product->name)>20?substr($orderList->product->name,0,20).'...':$orderList->product->name}}</td>
                                        <td><img src="{{asset($orderList->product->image_path)}}" class="product-img-2" alt="product img"></td>
