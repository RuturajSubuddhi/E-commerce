    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="col-sm-7 mt-2" style="padding: 0px;">
                <form action="{{route('admin.product_stock.payment.store')}}" method="post" id="paymentshow">
                    @csrf
                    <div class="rightpos">
                                ...
                                <div class="purchase_footer_first">
                                    <div style="display: flex;padding: 0px 10px" class="discountinput">
                                        ...
                                        <input type="number" name="total_discount" value="" id="discountamountset"
                                            oninput="countTotal()" class="form-control" placeholder="Discount">
                                    </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea name="supplier_address" class="form-control" id="supplier_address"
                                                    cols="10" rows="3" placeholder="Supplier Address"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="number" id="previous_due" class="form-control"
                                                    name="previous_due" placeholder="Due Balance" step="any" min="0">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea name="company_address" class="form-control" id="company_address"
                                                    cols="10" rows="3" placeholder="Company Address"></textarea>
                                            </div>
                                        </div>
