                    ...
                    <form action="{{route('admin.role.store')}}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-2 roldiv">
                                ...
                                <div class="col-sm-12 role_head">
                                    <h6>
                                        <p>Admin Access <input class="form-check-input" type="checkbox" value="h1" name="role_id[]" id="flexCheckDefault" checked></p>
                                    </h6>
                                </div>
                                <div class="col-sm-3">
                            ...
                            <div class="row mb-2 roldiv">
                                <div class="col-sm-12 role_head">
                                    <h6>
                                        <p>Sell Access <input class="form-check-input" type="checkbox" value="h2" name="role_id[]" id="flexCheckDefault" checked></p>
                                    </h6>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-check ">
                            ...
                            <div class="row mb-2 roldiv">
                                <div class="col-sm-12 role_head">
                                    <h6>
                                        <p>Product Access <input class="form-check-input" type="checkbox" value="h3" name="role_id[]" id="flexCheckDefault" checked></p>
                                    </h6>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-check ">
                            ...
                            <div class="row mb-2 roldiv">
                                <div class="col-sm-12 role_head">
                                    <h6>
                                        <p>Product Stock <input class="form-check-input" type="checkbox" value="h4" name="role_id[]" id="flexCheckDefault" checked></p>
                                    </h6>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-check ">
                            ...
                            <div class="row mb-2 roldiv">
                                <div class="col-sm-12 role_head">
                                    <h6>
                                        <p>Offer Setting <input class="form-check-input" type="checkbox" value="h5" name="role_id[]" id="flexCheckDefault" checked></p>
                                    </h6>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-check ">
                            ...
                            <div class="row mb-2 roldiv">
                                <div class="col-sm-12 role_head">
                                    <h6>
                                        <p>Setting <input class="form-check-input" type="checkbox" value="h6" name="role_id[]" id="flexCheckDefault" checked></p>
                                    </h6>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-check ">
                            ...
                            <div class="row mb-2 roldiv">
                                <div class="col-sm-12 role_head">
                                    <h6>
                                        <p>Bank <input class="form-check-input" type="checkbox" value="h7" name="role_id[]" id="flexCheckDefault" checked></p>
                                    </h6>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-check ">
                            ...
                            <div class="row mb-2 roldiv">
                                <div class="col-sm-12 role_head">
                                    <h6>
                                        <p>Order Access <input class="form-check-input" type="checkbox" value="h8" name="role_id[]" id="flexCheckDefault" checked></p>
                                    </h6>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-check ">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-check ">
                                        <input class="form-check-input" type="checkbox" value="28" name="role_id[]" id="flexCheckDefault" checked>
                                        <label class="form-check-label" for="flexCheckDefault">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-check ">
                                        <input class="form-check-input" type="checkbox" value="29" name="role_id[]" id="flexCheckDefault" checked>
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Refund Completed
                                        </label>
                                    </div>
                            ...
                            <div class="row mb-2 roldiv">
                                <div class="col-sm-12 role_head">
                                    <h6>
                                        <p>Report <input class="form-check-input" type="checkbox" value="h9" name="role_id[]" id="flexCheckDefault" checked></p>
                                    </h6>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-check ">
