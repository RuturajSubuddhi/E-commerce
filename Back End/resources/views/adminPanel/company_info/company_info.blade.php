...
<div class="page-content">
    ...
    <form method="post" action="{{route('company_info.update')}}">
        @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label for="exampleInputPassword1" class="form-label">Instagram
                                            </label>
                                            <input type="text" name="instagram_link"
                                                value="{{$companyInfo->instagram_link}}" class="form-control"
                                                id="exampleInputPassword1">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label for="exampleInputPassword1" class="form-label">Whatsapp
                                            </label>
                                            <input type="text" name="whatsapp_link"
                                                value="{{$companyInfo->whatsapp_link}}" class="form-control"
                                                id="exampleInputPassword1">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="return_policy" id="" cols="30" rows="3">{{$companyInfo->return_policy}}</textarea>
                             ...
                             <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="promobar" id="" cols="30" rows="3">{{$companyInfo->promobar}}</textarea>
