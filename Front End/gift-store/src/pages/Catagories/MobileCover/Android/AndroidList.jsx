...
import "../../../../styles/MobileCover/Android.css";
import { Heart } from "lucide-react";
import { useNavigate } from "react-router-dom";
import { androidData } from "../../../../data/MobileCover/AndroidData";
    ...
    return (
        <div className="wooden-katana-page">
            ...
            <Container className="py-5">
                ...
                <Row className="g-4">
                    <AnimatePresence>
                        {androidData.slice(0, visibleCount).map((item, index) => (
                                ...
                                >
                                    <Card className="katana-card text-center">
                                        ...
                                        <div className="image-container" style={{ cursor: "pointer" }}
                                            onClick={() => navigate(`/Android/${item.id}`)}>
                ...
                {/* 🔘 Load More Button */}
                {visibleCount < androidData.length && (
