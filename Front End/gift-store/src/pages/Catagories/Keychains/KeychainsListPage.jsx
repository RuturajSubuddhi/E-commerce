...
export default function KeychainsListPage() {
    ...
    const titleMap = {
        ...
        112: "Footballers",
        113: "Starbucks",
        114: "Camera Keychains",


    };

    const pageTitle = titleMap[subcategoryId] || "keychains";
                                    ...
                                    <Card className="katana-card text-center">
                                        ...
                                        <Card.Body>
                                            ...
                                            <Card.Title
                                                ...
                                                style={{ cursor: "pointer" }}
                                                onClick={() => navigate(`/catagories/Keychains/details/${item.id}`)}
                                            >
                                                {item.name}
                                            </Card.Title>
