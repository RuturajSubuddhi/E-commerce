...
export default function AFListPage() {
    ...
    const pageTitle = titleMap[subcategoryId] || "Action Figures";
                                ...
                                <motion.div whileHover={{ scale: 1.05 }} transition={{ duration: 0.3 }}>
                                    <Card className="katana-card text-center">
                                        ...
                                        <div
                                            ...
                                            onClick={() =>
                                                navigate(`/catagories/action-figures/details/${item.id}`)
                                            }
                                        >
                                            <img
